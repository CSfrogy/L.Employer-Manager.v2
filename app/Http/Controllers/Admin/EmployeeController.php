...
class EmployeeController extends Controller
{
    ...
    public function deleteEmployeeFromDashboard(Request $request)
    {
        try {
            $employee = Employee::findOrFail($request->id);
            ...
            return redirect()->route('admin.dashboard')
                ->with('employee_success', "Employee '{$employeeName}' has been successfully deleted");
        } catch (\Exception $e) {
            return redirect()->route('admin.dashboard')
                ->with('employee_error', 'Failed to delete employee. Please try again.');
        }
    }
}
